...
public class CartChildAdapter {
    ...
    public CartChildAdapter(String Fixprice, String tovarcartShopuid, String tovarValue, String productId, String price, String tovarname, String tovarImage) {
